...
public class C01_Maven {
    public static void main(String[] args) throws InterruptedException {
        ...
        driver.manage().window().maximize();  // bunu her hodun basinda yazmaya alis
        driver.manage().timeouts().implicitlyWait(5, TimeUnit.SECONDS);  // bunu da her kodun basinda yazmaya alis.

        // class'in basinda impliciitlyWait komutu yazilirsa bu test boyunca
        // her locator icin maximum zaman kadar bekler.
